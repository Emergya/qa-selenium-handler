...
public class Initialization {
    ...
    public EmergyaWebDriver initialize() {
        ...
        if (browser.equalsIgnoreCase("Firefox")) {
            ...
            firefoxProfile
                    .setPreference("browser.helperApps.neverAsk.saveToDisk", "application/x-jar, application/application/vnd.android.package-archive, application/msword, application/x-rar-compressed,"
